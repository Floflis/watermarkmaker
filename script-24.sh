...
convert watermark.png -size 511x81 \
  \( xc:transparent -font "Arial" -pointsize 16 -fill black -draw "text 80,75 'Build attempt $specialbuildattempt'" -blur 0x1 \) \
  -geometry +2+2   -composite \
  -font "Arial" -fill white -pointsize 16 -draw "text 80,75 'Build attempt $specialbuildattempt'" \
  watermark.png
