...
convert watermark.png -size 511x81 \
  \( xc:transparent -font "Arial" -pointsize 32 -fill black -draw "text 40,80 'Evaluation compilation. Build 2301 Eusoumafoca'" -blur 0x1 \) \
  -geometry +2+2   -composite \
  -font "Arial" -fill white -pointsize 32 -draw "text 40,80 'Evaluation compilation. Build 2301 Eusoumafoca'" \
  watermark.png
